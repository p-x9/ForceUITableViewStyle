#import "FTSHeaderView.h"
#import <Preferences/PSListController.h>
#import <Preferences/PSSpecifier.h>

@interface FTSHeaderView()
...
- (id)initWithSpecifier:(PSSpecifier *)specifier {
    ...
    self.titleLabel.text = @"ForceUITableViewStyle";
    self.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Ultralight" size:36];
    self.titleLabel.textAlignment = NSTextAlignmentCenter;
    [self.titleLabel sizeToFit];
    
    self.subTitleLabel.text = @"Replace UITableView Style";
